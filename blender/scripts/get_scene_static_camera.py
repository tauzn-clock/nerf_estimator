...
DATA_PATH = os.path.join(FILE_PATH, 'test/jackal_floor_training_data_1')
print(DATA_PATH)
...
for frame in transforms['frames']:
    ...
    object_transform = final_pose @ invert_pose(transform_matrix)
    ...
    set_object_pose("base_link",object_xyz,object_rpy)
...
DATA_PATH = os.path.join(FILE_PATH, 'data/jackal_floor_training_data_1')
print(DATA_PATH)
...
for frame in transforms['frames']:
    ...
    inverse = invert_pose(transform_matrix)
